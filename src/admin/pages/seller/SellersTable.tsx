import { Button, FormControl, InputLabel, MenuItem, Paper, Select, Table, TableBody, TableCell, 
...
const accountStatusMap=[
    ...
    {status:"DEACTIVED",title:"Deactived",description:"Account is deactivated by user or admin"},
    {status:"BANNED",title:"Banned",description:"Account is permanently banned due to violations"},
    {status:"CLOSED",title:"Closed",description:"Account is permanently closed by user or system"},
];
        ...
        <>
            <div className="pb-5 w-60">
                <FormControl fullWidth>
                  ...
                  >
                    {
                        accountStatusMap.map((item)=> <MenuItem value={item.status}>{item.title}</MenuItem>)  
                    }
                ...
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                  <TableHead>
                    <TableRow>
                      ...
                      <StyledTableCell align="right">NDS</StyledTableCell>
