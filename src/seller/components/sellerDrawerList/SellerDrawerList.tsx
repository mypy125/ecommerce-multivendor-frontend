import { AccountBalanceWallet, AccountBox, Add, Dashboard, Inventory, 
    Logout, Mail, Receipt, ShoppingBag 
...
const menu=[
    ...
    },
    {
        ...
        icon: <Mail className="text-primary-color"/>,
        activeIcon: <Mail className="text-white"/>,
    },
];
